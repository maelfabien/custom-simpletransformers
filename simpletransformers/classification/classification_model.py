...
class ClassificationModel:
    def __init__(
        self, model_type, model_name, num_labels=None, model_config = None, model_head = None, model_tokenizer = None, weight=None, args=None, use_cuda=True, cuda_device=-1, **kwargs,
